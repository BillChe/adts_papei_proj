...
import com.example.adts_papei_proj.data.LoginRepository;
import com.example.adts_papei_proj.data.Result;
...
public class LoginViewModel extends ViewModel {
    ...
    public void loginDataChanged(String username, String password) {
        if (!isUserNameValid(username)) {
            loginFormState.setValue(new LoginFormState(R.string.invalid_user_email, null));
